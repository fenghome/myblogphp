var zbp = new ZBP({
    bloghost: "http://zblog.io/",
    ajaxurl: "http://zblog.io/zb_system/cmd.php?act=ajax&src=",
    cookiepath: "/"
});
...
function notify(s){
    if (window.webkitNotifications) {
        if (window.webkitNotifications.checkPermission() == 0) {
            var zb_notifications = window.webkitNotifications.createNotification('http://zblog.io/zb_system/image/admin/logo-16.png', '通知', s);
...
$(document).ready(function(){
    ...
    if ($("div.divHeader,div.divHeader2").first().css("background-image") == "none") { 
        AddHeaderIcon("http://zblog.io/zb_system/image/common/window.png");
    }
